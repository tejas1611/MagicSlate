...
public class ExercisesFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        Button button = rootView.findViewById(R.id.WheelChallenge);
        button.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                onClickWheelChallenge();
            }
        });
        return rootView;
    }

    public void onClickWheelChallenge() {
        Intent i = new Intent(getActivity(), WheelChallenge.class);
        startActivity(i);
    }
}
